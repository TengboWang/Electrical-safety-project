...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/huasi/AllNeedCopy_datasets/dianli/YOLOv5_DOTA_OBB-master/runs/total_chips/exp10_chips_improve/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/home/huasi/AllNeedCopy_datasets/dianli/YOLOv5_DOTA_OBB-master/inference/clip_images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='/home/huasi/AllNeedCopy_datasets/dianli/YOLOv5_DOTA_OBB-master/inference/detect_images', help='output folder')  # output folder
    ...
    parser.add_argument('--device', default='1,2,3,4,5,6,7', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
